...
define(['area'], function(Area) {
    ...
    var AudioManager = Class.extend({
        init: function(game) {
            ...
            this.areas = [];
            this.musicNames = ["village","beach", "forest", "cave", "desert", "lavaland", "boss", "oavillage", "oaforest", "overworld","oacave","oawind","oaforesttown","oatitle","oaporttown","oaplanes","oacave2","oahome"];
