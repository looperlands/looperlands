...
define(['area'], function(Area) {
    ...
    var AudioManager = Class.extend({
        init: function(game) {
            ...
            this.areas = [];
            this.musicNames = ["village","beach", "forest", "cave", "desert", "lavaland","oacrystal", "boss", "oavillage", "oaforest","oasnowthaven", "overworld","oaseacombat","oacave","oawind","oaforesttown","oatitle","oaporttown","oaplanes","oacave2","oaforestboss","oahome","oaspiderboss","oaforest2","cobsfarmmain"];
