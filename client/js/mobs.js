define(['mob', 'timer'], function(Mob, Timer) {
    ...
    var Mobs = {
       ...
       cobWalkingNpc5: Mob.extend({
        ...
        RABBID: Mob.extend({ init: function(id) {this._super(id, Types.Entities.RABBID); this.moveSpeed = 100 + Math.random()*100; this.atkSpeed = 50 + Math.random()*25; this.idleSpeed = 250; this.isAggressive = true; this.aggroRange = 1 + Math.random()*3; this.deathAnimated = true;}}),
        ZOMBBID: Mob.extend({ init: function(id) {this._super(id, Types.Entities.ZOMBBID); this.moveSpeed = 100 + Math.random()*200; this.atkSpeed = 50 + Math.random()*30; this.idleSpeed = 250; this.isAggressive = true; this.aggroRange = 1 + Math.random()*1; this.deathAnimated = true;}}),
        HOPPURP: Mob.extend({ init: function(id) {this._super(id, Types.Entities.HOPPURP); this.moveSpeed = 100 + Math.random()*250; this.atkSpeed = 50 + Math.random()*40; this.idleSpeed = 250; this.deathAnimated = true;}}),
        HOPPINK: Mob.extend({ init: function(id) {this._super(id, Types.Entities.HOPPINK); this.moveSpeed = 100 + Math.random()*250; this.atkSpeed = 50 + Math.random()*50; this.idleSpeed = 250; this.deathAnimated = true;}}),
