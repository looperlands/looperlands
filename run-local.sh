...
cd ../..
docker build . -t blah && docker run -e LOOPWORMS_API_KEY=$LOOPWORMS_API_KEY -e LOOPWORMS_LOOPQUEST_BASE_URL=$LOOPWORMS_LOOPQUEST_BASE_URL -e DISCORD_TOKEN=$DISCORD_TOKEN -t -i -p 8000:8000 -t blah