...
quests = [
    {
        ...
        inProgressText: "Keep pushing them back! We need {{remaining}} more slimes defeated!",
        endText: "Well done, adventurer! You've pushed back the slimes and given us some much-needed relief.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "Great job! Only {{remaining}} boar hides left to gather!",
        endText: "Thank you! These boar hides will help us greatly. Your assistance is invaluable.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Stay strong! Defeat the Slime King to save our village!",
        endText: "You've done it! The Slime King is no more. You've brought peace to our village once again.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "You're doing great! Only {{remaining}} Gnashlings left to defeat!",
        endText: "You've done it! The Gnashlings are pushed back, and we have a chance to reclaim the plains.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "Focus on Thudlord! Retrieve that key to uncover their secrets!",
        endText: "You've slain Thudlord and retrieved the key! This will help us understand the menace we're facing.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.DRAYLEN,
    ...
    },
    {
        ...
        inProgressText: "You're close! Retrieve the relics from Razorclaw and Grizzlefang!",
        endText: "You've obtained the Luminous Orb and Crystalline Shard! These relics hold immense power and might be the key to our troubles.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.DRAYLEN,
    ...
    },
    {
        ...
        inProgressText: "Almost there! Clear out the remaining spiders!",
        endText: "You've quelled the spiders and brought some light back to Silkthread Pass. Thank you.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "You're almost there! Collect the remaining bat wings!",
        endText: "Thank you for dealing with the bats. Their wings will provide valuable insights.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.LIORA,
    ...
    },
    {
        ...
        inProgressText: "You're close! Defeat the Arachweave and retrieve the key!",
        endText: "You've slain the Arachweave and reclaimed the key. Excellent work.",
        eventType: "KILL_MOB",
        npc: Types.Entities.LIORA,
    ...
    },
    {
        ...
        inProgressText: "Keep going! Find the Dawnbloom Hermit's hidden abode!",
        endText: "You've located the Dawnbloom Hermit's dwelling. Well done.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Confront the source of the curse and lift it from Dawnbloom!",
        endText: "You've broken the curse and brought life back to Dawnbloom. Thank you, hero.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "Challenge the Glacialord and restore balance to the enclave!",
        endText: "You've defeated the Glacialord and saved Everfrost Enclave. Your bravery is unmatched.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "Explore the enclave and gather the icebound crystals!",
        endText: "You've delivered the icebound crystals. They are truly a treasure.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Search the enclave and recover the researcher's satchel!",
        endText: "You've recovered the satchel. This research is invaluable.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.EDUR,
    ...
    },
    {
        ...
        inProgressText: "Defeat the crystoliths and gather their essence quickly!",
        endText: "You've extracted the essences. They are filled with raw power.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Ascend Frostharrow Keep and defeat the Night King!",
        endText: "The Night King is vanquished. You have brought hope back to our lands.",
        eventType: "KILL_MOB",
        npc: Types.Entities.TORIAN,
        target: Types.Entities.NIGHTHARROW,
        amount: 1,
        requiredQuest: "OA_QUEST_12",
        level: 21,
        medal: Types.Medals.HEARTH,
        needToReturn: true
    },
    {
        ...
        inProgressText: "Recover the Doomforged Greatswords from the Night King's guards!",
        endText: "You've brought back the swords. They will be repurposed for our cause.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.TORIAN,
    ...
    },
    {
        ...
        inProgressText: "Engage and defeat the Gloomforged Warriors!",
        endText: "You've weakened the Night King's forces. Our path is clearer now.",
        eventType: "KILL_MOB",
        npc: Types.Entities.TORIAN,
    ...
    },
    {
        ...
        inProgressText: "Recover the banners from Frostharrow Keep!",
        endText: "You've recovered the banners. This is a significant blow to the Night King's propaganda.",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.TORIAN,
    ...
    },
    {
        ...
        inProgressText: "Confront and defeat Silkshade, the Spider Queen!",
        endText: "You've bested Silkshade. Peace may finally return to Silkthread Pass.",
        eventType: "KILL_MOB",
        npc: Types.Entities.LIORA,
    ...
    ///SIDE QUESTS///
    {
        ...
        inProgressText: "Collect the Red Ooze from the slimes!",
        endText: "You've collected enough Red Ooze. This will be very useful.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Search the barrels for hidden weapons!",
        endText: "You've crippled the Gnashling's supplies. Well done!",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.DRAYLEN,
    ...
    },
    {
        ...
        inProgressText: "Gather the Magic Mushrooms from the cave!",
        endText: "Wonderful! These Magic Mushrooms will be perfect for our research. Thank you.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Collect the berries from the bushes around town!",
        endText: "Whoah whoah! Don't eat those! Just kidding. Thank you for the berries!",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Round up the mischievous kittens around town!",
        endText: "Wow! What a good samaritan! Thank you for finding Whiskers' kittens.",
        eventType: "LOOT_ITEM",
    ...
    {
        id: "OA_SIDE_6",
        name: "They tricked us! They betrayed us!",
        ...
        inProgressText: "Defeat the Wildgrins and teach them a lesson!",
        endText: "That should teach them a lesson! Glink happy now, thank you.",
        eventType: "KILL_MOB",
    ...
    },
    {
        ...
        inProgressText: "Retrieve Glink's stolen pearls from the Wildgrins!",
        endText: "My preciouses!! Glink happy! Thank you, new friend!",
        eventType: "LOOT_ITEM",
        npc: Types.Entities.GLINK,
    ...
    },
    {
        ...
        inProgressText: "Collect the slime sludge for Gripnar!",
        endText: "Gripnar thanks you! This sludge will make weapon very nasty.",
        eventType: "LOOT_ITEM",
    ...
    ////EVERPEAK QUESTS
    {
        ...
        inProgressText: "Explore the fishing isle and discover its secrets!",
        endText: "You've discovered the fishing island! Enjoy your time there.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        startText: "Discover the Gilded Gryphon", 
        ...
        inProgressText: "Find and visit the Gilded Gryphon Tavern!",
        endText: "You've discovered the Gilded Gryphon Tavern! Enjoy your stay.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Explore the Enchanted Glade construction site!",
        endText: "You've discovered the Enchanted Glade site! It's truly magical.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Find and experience the Stormhelm Arena!",
        endText: "You've discovered Stormhelm Arena! Prepare for the battles ahead.",
        eventType: "LOOT_ITEM",
    ...
    },
    {
        ...
        inProgressText: "Explore and discover the Riverbreeze District!",
        endText: "You've discovered the Riverbreeze District! Enjoy its vibrant life.",
        eventType: "LOOT_ITEM",
