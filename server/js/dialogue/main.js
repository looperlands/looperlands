// This file loads the dialogues for the `main` map.
// We've split the dialogues into separate files for better readability and maintainability.
// You can only have one dialogue per NPC, if multiple dialogues are defined for the same NPC, the first one will be used.
